...
center = (result.ebars$lower+result.ebars$upper)/2
radius = abs(result.ebars$upper-result.ebars$lower)/2
t.ebars = cbind(runif(I.test,center[1]-radius[1]*0.99,center[1]+radius[1]*0.99),runif(I.test,center[2]-radius[2]*0.5,center[2]+radius[2]*0.5))
...
t.pme = cbind(runif(I.test,-50,50),runif(I.test,-50,50))
