...
dim_names = list(c("Case 1","Case 2","Case 3","Case 4"),c("EBARS 1","EBARS 2","EBARS 3","BARS","TPS"))
...
y_bars = binbars_fit(x_new[,1],x_new[,2],binbars)
...
mse_array[i,5,k] = mean(sort((y_new-y_tps)^2)[round(p*m_test):round((1-p)*m_test)])
